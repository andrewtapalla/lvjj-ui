  ...
  <div className="App">
      ...
      <header>
        <Navbar className="NavBar" expand="lg" sticky="top">
            <Navbar.Brand href="/" className="lvjj-logo"><img src={process.env.PUBLIC_URL + './images/lvjj.png'} height="65" width="65"/></Navbar.Brand>
            <Navbar.Toggle id="navBar-toggle" />
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="justify-content-end" style={{ width: "89%" }}>
